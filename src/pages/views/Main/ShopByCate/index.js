...
const ShopByCate = ({cateProducts, products}) => {
    let {id} = useParams();
    const productsByCate = products.filter(productByCate => productByCate.cateId == id);
    return (
        <div>
            ...
            <div className="container">
                ...
                <div className="col-lg-9 order-1 order-lg-2">
                    ...
                    <div className="row">
                        {productsByCate.map(({id, cateId, name, image, price}) => (
