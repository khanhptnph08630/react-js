...
const BlogByCate = ({cateBlogs, blogs}) => {
    let {id} = useParams();
    const blogsByCate = blogs.filter(blogByCate => blogByCate.cateId == id);
    return (
        <div>
            <div className="breacrumb-section">
                ...
                <div className="container">
                    ...
                    <div className="col-lg-9 order-1 order-lg-2">
                        <div className="row">
                            {blogsByCate.map(({id, title, image, description, content}) => (
